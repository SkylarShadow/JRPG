...
public:
	virtual class FTurnAbilityTimerManager* GetTurnAbilityTimerManager();

	virtual void DestroyTurnAbilityTimerManager();

	class FTurnAbilityTimerManager* GlobalTurnAbilityTimerManager;
