...
FTurnAbilityTimerManager* UAbilitySystemGlobals::GetTurnAbilityTimerManager()
{
	if (GlobalTurnAbilityTimerManager == nullptr)
	{
		GlobalTurnAbilityTimerManager = new FTurnAbilityTimerManager();
	}

	return GlobalTurnAbilityTimerManager;
}

void UAbilitySystemGlobals::DestroyTurnAbilityTimerManager()
{
	if (GlobalTurnAbilityTimerManager != nullptr)
	{
		delete(GlobalTurnAbilityTimerManager);

		GlobalTurnAbilityTimerManager = nullptr;
	}
}
